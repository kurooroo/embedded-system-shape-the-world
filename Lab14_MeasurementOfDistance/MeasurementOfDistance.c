...
unsigned long Convert(unsigned long sample){
	...
	_result = (unsigned long)(sample*2000/4096) + 1;
  return _result;  // replace this line with real code
}

// Initialize SysTick interrupts to trigger at 40 Hz, 25 ms
void SysTick_Init(unsigned long period){
	NVIC_ST_CTRL_R = 0;         // disable SysTick during setup
  NVIC_ST_RELOAD_R = period*80000 - 1;	// reload value
  ...
  GPIO_PORTF_DIR_R = 0x02;          // 5) PF4,PF0 input, PF3,PF2,PF1 output   
